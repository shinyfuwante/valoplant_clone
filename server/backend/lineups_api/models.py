...
class Lineup(models.Model):
    ...
    stand_img = CloudinaryField('image', blank=True, null=True) # image to show where to stand if needed (precise lineups)
    aim_img = CloudinaryField('image', blank=True, null=True) # image where to line up or aim 
